...
<body>
    ...
    <form runat="server">
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark p-0">
            <div class="container">
                <a href="index.aspx" class="navbar-brand ml-3">
        ...
        <section id="actions" class="py-4 mb-4">
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3" runat="server" id="openemployeemodal" visible="false">
                        <a
                            href="#"
                    ...
                    <div class="col-md-3" runat="server" id="opendepartmodal" visible="false">
                        <a
                            href="#"
                    ...
                    <div class="col-lg-3 d-none d-lg-block">
                        <div class="card text-center bg-primary text-white mb-3">
                            <div class="card-body">
                                ...
                                <a href="inventory.aspx" class="btn btn-outline-light btn-sm">View</a>
                            </div>
                        </div>
                        ...
                        <div class="card text-center bg-warning mb-5" runat="server" id="blockopenemployees" visible="false">
                            <div class="card-body">
                                <h3>Employees</h3>
                                <h4 class="display-4"><i class="fas fa-users"></i></h4>
                                <a href="employees.aspx" class="btn btn-outline-dark btn-sm">View</a>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-group">
                            <div class="input-group">
                                ...
                                <ContentTemplate>
                                <asp:DropDownList ID="DropDownListsupplier" runat="server" CssClass="form-control" AutoPostBack="true" OnSelectedIndexChanged="DropDownListsupplier_SelectedIndexChanged"></asp:DropDownList>
                            ...
                            <div class="input-group">
                                ...
                                <asp:TextBox
                                    ...
                                    CssClass="form-control"></asp:TextBox>
                                        ...
                                        <asp:RequiredFieldValidator ID="SupNameValid" runat="server" ErrorMessage="Supplier name required" ControlToValidate="supNameTxt"></asp:RequiredFieldValidator>
                                    <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <label
                                ...
                                <asp:TextBox
                                    ...
                                    CssClass="form-control"></asp:TextBox>
                                        ...
                                        <asp:RegularExpressionValidator ID="PhoneRegexValid" runat="server" ErrorMessage="Phone number not proper format" ControlToValidate="supPhoneTxt" ValidationExpression="^[2-9]\d{2}-\d{3}-\d{4}$"></asp:RegularExpressionValidator>
                                    <div class="form-group">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <label
                                ...
                                <asp:TextBox
                                    ...
                                    CssClass="form-control"></asp:TextBox>
                                        ...
                                        <asp:RegularExpressionValidator ID="EmailRegexValid" runat="server" ErrorMessage="Email not in proper format" ControlToValidate="supEmailTxt" ValidationExpression="^([\w-\.]+)@((\[[0-9]{1,3}\.[0-9]{1,3}\.[0-9]{1,3}\.)|(([\w-]+\.)+))([a-zA-Z]{2,4}|[0-9]{1,3})(\]?)$"></asp:RegularExpressionValidator>
                                        </asp:Panel>
                    ...
                    <div class="modal-footer">
                        ...
                        <asp:UpdatePanel ID="IUpdatePanel" runat="server">
                            <ContentTemplate>
                                <asp:Label ID="itemstatuslabel" runat="server" Text="" Visible="false"></asp:Label>
                                <asp:Button
                                    ID="createItemButton"
                                    runat="server"
                                    Text="Create"
                ...
                <div class="modal-content">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:LinkButton
                                            ...
                                            CssClass="btn btn-success input-group-append mr-5"><i class="fa fa-search fa-lg align-self-center"></i
                      ></asp:LinkButton>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <asp:Label
                                            ID="TotalLabel"
                                            runat="server"
                                            CssClass="input-group-text bg-white d-flex ml-auto mb-2"></asp:Label>
                                    </div>
                    ...
                    <div class="modal-footer">
                        <asp:UpdatePanel ID="POBUpdatePanel" runat="server">
                            <ContentTemplate>
                        <asp:Label ID="POstatuslbl" runat="server" Text="" Visible="false"></asp:Label>
                        <asp:Button
                            ID="CreatePOButton"
                            runat="server"
                            Text="Create"
        ...
        <div class="modal fade" id="addEmployeeModal" runat="server" visible="false">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form>
                            <div class="form-group">
                                ...
                                <asp:TextBox ID="efirsttxt" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="form-group">
                                <label for="elasttxt">Last Name</label>

                                <asp:TextBox ID="elasttxt" runat="server" CssClass="form-control"></asp:TextBox>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="btn-group btn-group-toggle" data-toggle="buttons">
                                    <label class="btn btn-success">
                                        <asp:RadioButton ID="yesToggle" runat="server" GroupName="admintoggle" />

                                        Yes
                   
                                    </label>
                                    <label class="btn btn-warning active">
                                        <asp:RadioButton ID="noToggle" runat="server" GroupName="admintoggle" Checked="True" />
                                        No
                    ...
                    <div class="modal-footer">
                        <asp:UpdatePanel ID="EUpdatePanel" runat="server">
                            <ContentTemplate>
                                <asp:Label ID="employeestatuslabel" runat="server" Text="" Visible="false"></asp:Label>
                                <asp:Button ID="createEmployeeBtn" runat="server" Text="Create" CssClass="btn btn-success" OnClick="createEmployeeButton_Click" />
                            </ContentTemplate>
                        </asp:UpdatePanel>
        ...
        <div class="modal fade" id="addDepartmentModal" runat="server" visible="false">
            <div class="modal-dialog modal-md">
                <div class="modal-content">
